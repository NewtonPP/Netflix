...
const MovieRow1 = () => {
    ...
    const MoviesUrl1 = 'https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1';
    const MoviesUrl2 = 'https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=revenue.desc';
    const MoviesUrl3 = 'https://api.themoviedb.org/3/movie/popular?language=en-US&page=1';
    const MoviesUrl4 = 'https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=1';

    
const TvUrl1 = 'https://api.themoviedb.org/3/tv/airing_today?language=en-US&page=1';
const TvUrl2 = 'https://api.themoviedb.org/3/tv/on_the_air?language=en-US&page=1';
const TvUrl3 = 'https://api.themoviedb.org/3/tv/popular?language=en-US&page=1';
const TvUrl4 = 'https://api.themoviedb.org/3/tv/top_rated?language=en-US&page=1';
