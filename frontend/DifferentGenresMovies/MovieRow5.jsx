...
const MovieRow5 = () => {
    ...
    const MoviesUrl1 = 'https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=5';
    const MoviesUrl2 = 'https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=5&sort_by=revenue.desc';
    const MoviesUrl3 = 'https://api.themoviedb.org/3/movie/popular?language=en-US&page=5';
    const MoviesUrl4 = 'https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=5';
