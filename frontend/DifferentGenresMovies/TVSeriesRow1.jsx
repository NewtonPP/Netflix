...
const TVSeriesRow1 = () => {
    ...
    const TVSeriesurl1 = 'https://api.themoviedb.org/3/tv/airing_today?language=en-US&page=1';
    const TVSeriesurl2 = 'https://api.themoviedb.org/3/tv/on_the_air?language=en-US&page=1';
    const TVSeriesurl3 = 'https://api.themoviedb.org/3/tv/popular?language=en-US&page=1';
    const TVSeriesurl4 = 'https://api.themoviedb.org/3/tv/top_rated?language=en-US&page=1';

    useEffect(() => {
        const fetchMoviesAndSeries = async () => {
            try {
                const [TVResponse1, TVResponse2, TVResponse3,TVResponse4] = await Promise.all([
